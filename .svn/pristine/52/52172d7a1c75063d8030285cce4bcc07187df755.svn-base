package org.marmots.generator.utils.naming;
...
/**
 * Transforms words to singular, plural, humanized (human readable), underscore, camel case, or ordinal form. This is inspired by the
 * <a href="http://api.rubyonrails.org/classes/Inflector.html">Inflector</a> class in <a href="http://www.rubyonrails.org">Ruby on Rails</a>, which is distributed under the
...
public class Inflector {
  ...
  /**
   * By default, this method converts strings to UpperCamelCase. If the <code>uppercaseFirstLetter</code> argument to false, then this method produces lowerCamelCase. This method
   * will also use any extra delimiter characters to identify word boundaries.
   * 
   * Examples:
   * 
   * <pre>
  ...
  /**
   * Makes an underscored form from the expression in the string (the reverse of the {@link #camelCase(String, boolean, char[]) camelCase} method. Also changes any characters that
  ...
  /**
   * Capitalizes the first word and turns underscores into spaces and strips trailing "_id" and any supplied removable tokens. Like {@link #titleCase(String, String[])}, this is
   ...
   * of the supplied tokens are removed. Like {@link #humanize(String, String[])}, this is meant for creating pretty output.
   * 
   * Examples:
   * 
   * <pre>
   ...
   * 
   * The Java {@link Pattern regular expression processing} does not use the preprocessing directives <code>\l</code>, <code>&#92;u</code>, <code>\L</code>, and <code>\U</code>. If
   * so, such directives could be used in the replacement string to uppercase or lowercase the backreferences. For example, <code>\L1</code> would lowercase the first
   * backreference, and <code>&#92;u3</code> would uppercase the 3rd backreference.
   * 
   * 
   * @param input the input string
   * @param regex the regexp string
   * @param groupNumberToUppercase wich group number to uppercase
